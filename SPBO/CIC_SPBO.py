...
# /home/oarreche/FeatureSelection/db/CICIDS/Friday-WorkingHours-Afternoon-DDos.pcap_ISCX.csv

df0 = pd.read_csv ('/home/oarreche/FeatureSelection/db/CICIDS/Wednesday-workingHours.pcap_ISCX.csv', usecols=req_cols)

df1 = pd.read_csv ('/home/oarreche/FeatureSelection/db/CICIDS/Tuesday-WorkingHours.pcap_ISCX.csv', usecols=req_cols)

df2 = pd.read_csv ('/home/oarreche/FeatureSelection/db/CICIDS/Thursday-WorkingHours-Morning-WebAttacks.pcap_ISCX.csv', usecols=req_cols)

df3 = pd.read_csv ('/home/oarreche/FeatureSelection/db/CICIDS/Thursday-WorkingHours-Afternoon-Infilteration.pcap_ISCX.csv', usecols=req_cols)

df4 = pd.read_csv ('/home/oarreche/FeatureSelection/db/CICIDS/Monday-WorkingHours.pcap_ISCX.csv', usecols=req_cols)

df5 = pd.read_csv ('/home/oarreche/FeatureSelection/db/CICIDS/Friday-WorkingHours-Morning.pcap_ISCX.csv', usecols=req_cols)

df6 = pd.read_csv ('/home/oarreche/FeatureSelection/db/CICIDS/Friday-WorkingHours-Afternoon-DDos.pcap_ISCX.csv', usecols=req_cols)

df7 = pd.read_csv ('/home/oarreche/FeatureSelection/db/CICIDS/Friday-WorkingHours-Afternoon-PortScan.pcap_ISCX.csv', usecols=req_cols)
...
spbo_scores.sort_values(ascending=False).to_csv('SPBO_CIC_feature_ranking.csv')
